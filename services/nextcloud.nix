  ...
  options.services.nextcloud = {
    ...
    nginx.enable = mkOption {
      ...
      description = ''
        ...
        Further nginx configuration can be done by adapting <literal>nginx.virtualHosts.&lt;name&gt;</literal>.
        See <link xlink:href="https://nixos.org/nixos/options.html#nginx.virtualhosts.%3Cname%3E"/> for further information.
      '';
    };
